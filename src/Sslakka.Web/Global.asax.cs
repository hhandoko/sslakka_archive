// -----------------------------------------------------------------------
// <copyright file="Global.asax.cs" company="Sslakka">
//   Copyright (c) 2014 - 2015 Sslakka and its contributors
//
...
namespace Sslakka.Web
{
    ...
    public class Global : HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            ActorSystem = ActorSystem.Create("sslakka");
